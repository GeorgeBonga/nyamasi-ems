...
// Import the Admin Drawer Navigator
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="RiderDeliveryScreen" component={RiderDeliveryScreen} />
        
        {/* Admin Drawer Navigator - All admin screens in one place */}
